...
class RecursiveFunctionTest {
	...
	@Test
	void PalindromeTest() {
		assertTrue(RecursiveFunctions.palindrome("ana") == true,"La palabra ana no es un palindromo");
		assertTrue(RecursiveFunctions.palindrome("reconocer") == true,"la palabra reconocer no es un palindromo" );
		assertTrue(RecursiveFunctions.palindrome("hola") == false,"la palabra hola no es un palindromo");
	}
